...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/go-kirito/pkg/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/go-kirito/pkg/transport/http/binding")
)
